 ...
 * Positioned at very bottom of display (rows 52-63)
 * Line 1 at Y=52, Line 2 at Y=58 (extends to ~Y=63 with 5px font)
 * Two lines of text, ~15 chars each = ~30 chars total
 */
const INSIGHT_LINE1_Y = 52; // First line (bottom area)
const INSIGHT_LINE2_Y = 58; // Second line (6px spacing for 5px font + 1px gap)
